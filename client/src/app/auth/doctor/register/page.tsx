    ...
    <div className="min-h-screen bg-[#0a0e1a] flex items-center justify-center p-4">
      <div className="w-full max-w-md animate-fadein">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-[#e8eaf0]">Doctor Registration</h1>
          <p className="text-[#8892a4] text-sm mt-1">Join our healthcare network</p>
        </div>
        ...
        <div className="glass-card p-8">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-sm font-medium text-[#8892a4]">Specialization</label>
              <select
                className="w-full h-11 bg-[#0a0e1a] border border-[#1e2d4a] rounded-xl text-[#e8eaf0] text-sm px-4 focus:outline-none focus:border-blue-500/60 focus:ring-2 focus:ring-blue-500/20"
